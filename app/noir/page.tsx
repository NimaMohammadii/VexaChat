      ...
      <AnimatePresence>
        {!started ? (
          <motion.div key="overlay" initial={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.965 }} transition={{ duration: 0.42, ease: [0.32, 0.72, 0, 1] }} className="absolute inset-0 z-30 flex items-center justify-center bg-[#020102] px-7">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_26%,rgba(74,9,31,0.2),rgba(0,0,0,0)_44%)]" />
            <div className="relative w-full max-w-sm text-center">
              <div className="mx-auto mb-7 flex h-20 w-20 items-center justify-center rounded-[28px] border border-[#5A1027]/38 bg-[#12070B]">
              ...
              <button type="button" onClick={() => void startSession()} disabled={starting} className="mt-8 h-[54px] w-full rounded-full border border-[#5A1027]/55 bg-[#200A13] px-8 text-sm font-semibold tracking-[0.12em] text-white shadow-[0_12px_30px_rgba(0,0,0,0.38)] transition-all duration-200 active:scale-[0.98] disabled:opacity-60">
